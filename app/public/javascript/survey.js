$(document).ready(function() {
    ...
    var questions = [
        ...
        'I can easily find the beauty in others.',
        'I easily connect with people I meet',
        'I cant be the center of attention.',
        'I enjoy a productive day off.',
        'I Lovd to spend time with my family',
        'I believe that everything happens for a reason.',
        'I find happiness in mentoring others.',
